...
public class FindOptimalSerFRParameters extends FindOptimalSFRParameters {
	...
	public FindOptimalSerFRParameters(String algorithm, String path, int threadsPerBox) {
		super(algorithm, path, threadsPerBox);
	}
	...
	protected List<Configuration> setupSimsToRun() throws ConfigurationException {
		...
		int simulationId = 1;
		for (int fullPowerRBs = 1; fullPowerRBs <= MAX_FULL_POWER_RBS; fullPowerRBs++) {
